...
if __name__ == "__main__":
    ...
    # with open("/home/rvsa/mj_playground_hand_env/para_env/xmls/reorient/reorient_hand.xml", "r") as f:
        # xml_file = f.read()
    with open("/home/rvsa/mj_playground_hand_env/para_env/xmls/rotateZ/rotateZ_hand_obj.xml", "r") as f:
    # with open("/home/rvsa/mj_playground_hand_env/para_env/xmls/grasp/hand_16dof_grasp.xml", "r") as f:
        xml_file = f.read()
